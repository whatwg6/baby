  ...
  return (
    <section className="rounded-card border border-line bg-white p-4 shadow-sm">
      <div className="flex items-center justify-between gap-3">
        ...
        <p className="shrink-0 text-sm text-muted">{data.length} 条</p>
      </div>
      ...
      <div className="mt-4 h-60">
        {data.length > 0 ? (
          ...
          <div className="flex h-full items-center justify-center rounded-card bg-cream px-4 text-center text-sm text-muted">
